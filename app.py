...
UI_TEXT = {
    "English": {
        ...
        "escape_text_label": "Paste any stuff that you need help understanding and simplifying.",
    ...
    "Español": {
        ...
        "tone_options": [
            ...
            "🚀 Tech Bro Supercafinado",
            "🕵️‍♂️ Detective Noir de los 40",
            "🧙‍♂️ Mago Sabio de Fantasía",
        ],
        "topic_label": "¿Qué te gustaría saber?",
        "topic_placeholder": "ej., Historia, Snoopy, Química, Baba Yega, Gobierno",
        "button_label": "Vamos a simplificarlo",
        "start_over": "🧹 Empezar de nuevo",
        "terms_button": "📜 Términos y Condiciones",
        "privacy_notice_box": '<div style="font-size: 0.8rem; padding: 10px; border-radius: 6px; background-color: rgba(2, 132, 199, 0.08); border-left: 4px solid #0284C7; margin-bottom: 15px;">🔒 <strong>Nota de Privacidad:</strong> No guardamos nada. Cualquier documento o información confidencial se procesa de forma transitoria y nunca se almacena.</div>',
        "no_api": " Por favor ingresa tu clave API de Gemini o configura la variable de entorno GEMINI_API_KEY.",
        "no_topic": "Por favor ingresa lo que necesitas que sea explicado.",
        "ready": {
            ...
            "Hard": "¡Hola y bienvenido! Tu respuesta está lista para darte ese dolor de cabeza que tanto te gusta.",
        },
        "subtitle": "**Respondiendo preguntas complejas de forma sencilla.**",
        "bottom_line": "Conclusión",
        "spinners": {
            "Easy": "Haciéndolo lo más simple posible...",
            "Balanced": "Preparando el café justo para la mayoría...",
        ...
        "fine_print_title": "Simplemente Explicado: Cláusulas, Condiciones, Asuntos Legales y Otros Documentos que Debemos Entender",
        "fine_print_subtitle": "Explicando y entendiendo cosas que nunca supimos y documentos inexplicables.",
        ...
        "footer_text": "--- \n Impulsado por SkyNet, ya lo sabemos.",
        "read_aloud_label": "♿ Léeselo a mí",
        "tab1_name": "💡 Simplemente Explicado",
        "tab2_name": "📄 Simplemente Explicado - Documentos",
        "tab3_name": "🚪 Simplemente Explicado - La Cláusula de Escape",
        "escape_title": "Simplemente Explicado - La Cláusula de Escape",
        "escape_subtitle": "Explicando las cosas de las que necesitamos escapar.",
        "escape_badge": "🚪 **El Laboratorio de Inteligencia definitivo 'Sácame de aquí' está activo y listo**.",
        "escape_doc_section": "📄 Veamos en qué necesitas ayuda.",
        "escape_text_label": "Pega cualquier texto con el que necesites ayuda para entender y simplificar.",
        ...
        "escape_lab_section": "🚪 Suite de Contingencia Operacional",
        "escape_urgency_label": "⚡ Escala de Urgencia: ¿cuál es tu nivel de 'salir de aquí' en:",
        "escape_persona_label": "¿Cómo lo estás explicando como:",
        "tactical_persona_prompt": "Selecciona tu marco de persona táctica a continuación",
        "end_suffering_btn_title": "🔴 TERMINAR MI SUFRIMIENTO 💀",
        "end_suffering_btn_desc": "(Un híbrido helado y tranquilo entre cadencia medida, sintaxis impredecible y aniquilación psicológica absoluta con elegancia)",
        ...
        "escape_spinner": "Ejecutando análisis de laboratorio operacional...",
        "escape_disclaimer": "*Nota: Podemos proporcionar orientación estratégica, pero no garantizamos resultados específicos. Sin embargo, ejecutar este protocolo te otorga una oportunidad de lucha significativamente mejor.*",
        "personas": {
            "Houdini Mode": ("🪄 Modo Houdini", "Trucos de magia para salir"),
            "Grandma Filter": ("👵 Filtro de Abuelita", "Guía cálida, paciente y reconfortante"),
            ...
            "Zen Negotiator": ("🧘 Negociador Zen", "Mediador tranquilo y sereno"),
            "Corporate Shark": ("🦈 Tiburón Corporativo", "¿Por dónde muerdo primero?"),
            "Bureaucracy Hacker": ("🕵️ Hacker de Burocracia", "Saltándose robots automatizados"),
        },
    },
    "Deutsch": {
        "lang_label": "🌐 **Sprache**",
        ...
        "tone_options": ["Freundlich", "Professionell", "Locker"],
        "topic_label": "Worüber möchten Sie mehr erfahren?",
        "topic_placeholder": "z.B. Geschichte, Chemie, Regierung",
        "button_label": "Vereinfachen lassen",
        ...
        "ready": {"Easy": "Bereit:", "Balanced": "Ausgewogen bereit:", "Hard": "Schwer bereit:"},
        "subtitle": "**Komplexe Fragen einfach beantwortet.**",
        "bottom_line": "Fazit",
        "spinners": {"Easy": "Wird vereinfacht...", "Balanced": "Bereite vor...", "Hard": "Sehr komplex..."},
        "pillar_headers": ["## Kernkonzept", "## Was ist das?", "## Wie funktioniert es?", "## Was geben wir auf?", "## Warum ist das wichtig?", "## Wie betrifft uns das?", "## Versteckte Fakten", "## Quellen"],
        "fine_print_title": "Einfach Erklärt: Klauseln und Bedingungen",
        "fine_print_subtitle": "Rechtliche Dokumente verstehen.",
        "choose_input_mode": "Wählen Sie die Eingabemethode:",
        "input_modes": ["Text einfügen", "URL"],
        "paste_label": "Fügen Sie Text ein.",
        "url_label": "URL einfügen:",
        "upload_label": "Bild hochladen:",
        "upload_pdf_label": "PDF hochladen:",
        "decode_button": "Verstehen",
        "simplifying_spinner": "Wird verarbeitet...",
        "fine_print_headers": ["## 🚦 Risiko", "## 📄 Klauseln"],
        "footer_text": "--- \n Erstellt von Einfach Erklärt",
        "read_aloud_label": "♿ Vorlesen",
        "tab1_name": "💡 Einfach Erklärt",
        "tab2_name": "📄 Dokumente",
        "tab3_name": "🚪 Ausstiegsklausel",
        "escape_title": "Die Ausstiegsklausel",
        "escape_subtitle": "Dem Entkommen gewidmet.",
        "escape_badge": "🚪 **Das Krisen-Labor ist aktiv**",
        "escape_doc_section": "📄 Szenario eingeben",
        "escape_text_label": "Text hier einfügen",
        "escape_text_placeholder": "Hier einfügen...",
        "escape_hint_label": "Zusätzlicher Fokus:",
        "escape_hint_placeholder": "z.B. Sofortige Eskalation...",
        "escape_lab_section": "🚪 Kontingenz-Suite",
        "escape_urgency_label": "⚡ Dringlichkeitsskala:",
        "escape_persona_label": "Persona:",
        "tactical_persona_prompt": "Wählen Sie Ihr taktisches Personen-Framework aus",
        "end_suffering_btn_title": "🔴 BEENDE MEIN LEIDEN 💀",
        "end_suffering_btn_desc": "(Ein eiskalt ruhiger Hybrid aus psychologischer Vernichtung)",
        "escape_run_btn": "🚀 Ausbruch ausführen",
        "escape_clear_btn": "🧹 Zurücksetzen",
        "escape_success": "Bereit!",
        "escape_no_text": "Bitte Text eingeben.",
        "escape_spinner": "Analysiere...",
        "escape_disclaimer": "*Nur zu Simulationszwecken.*",
        "personas": {
            "Houdini Mode": ("🪄 Houdini Modus", "Entkommens-Tricks"),
            "Grandma Filter": ("👵 Omas Filter", "Sanfte Beratung"),
            "Escape Hatch Locator": ("🎯 Fluchtluke", "Ausgangs-Radar"),
            "7-Year-Old Playground Mindset": ("🖍️ Kindermodus", "Einfache Logik"),
            "Ruthless Barrister": ("⚖️ Jurist", "Harte Verträge"),
            "Zen Negotiator": ("🧘 Zen", "Gelassenheit"),
            "Corporate Shark": ("🦈 Hai", "Aggressiv"),
            "Bureaucracy Hacker": ("🕵️ Hacker", "Bürokratie umgehen"),
        },
    },
    "Français": {
        "lang_label": "🌐 **Langue**",
        ...
        "tone_label": "🎭 **Ton / Persona**",
        "tone_options": ["Amical", "Professionnel", "Décontracté"],
        "topic_label": "Que souhaitez-vous savoir ?",
        "topic_placeholder": "ex., Histoire, Chimie",
        "button_label": "Simplifier",
        "start_over": "🧹 Recommencer",
        "terms_button": "📜 Termes & Conditions",
        "privacy_notice_box": '<div style="font-size: 0.8rem; padding: 10px; border-radius: 6px; background-color: rgba(2, 132, 199, 0.08); border-left: 4px solid #0284C7; margin-bottom: 15px;">🔒 <strong>Confidentialité :</strong> Rien n\'est stocké.</div>',
        "no_api": "Veuillez entrer votre clé API Gemini.",
        "no_topic": "Veuillez entrer un sujet.",
        "ready": {"Easy": "Prêt :", "Balanced": "Équilibré :", "Hard": "Difficile :"},
        "subtitle": "**Répondre simplement aux questions complexes.**",
        "bottom_line": "En Bref",
        "spinners": {"Easy": "Simplification...", "Balanced": "Préparation...", "Hard": "Complexe..."},
        "pillar_headers": ["## Concept Clé", "## Qu'est-ce que c'est ?", "## Comment ça marche ?", "## Ce qu'on abandonne", "## Pourquoi c'est important", "## Impact", "## Faits cachés", "## Sources"],
        "fine_print_title": "Simply Explained : Clauses et Conditions",
        "fine_print_subtitle": "Comprendre les documents juridiques.",
        "choose_input_mode": "Mode d'entrée :",
        "input_modes": ["Coller du texte", "URL"],
        "paste_label": "Collez le texte ici.",
        "url_label": "URL :",
        "upload_label": "Image :",
        "upload_pdf_label": "PDF :",
        "decode_button": "Simplifier",
        "simplifying_spinner": "En cours...",
        "fine_print_headers": ["## 🚦 Risques", "## 📄 Clauses"],
        "footer_text": "--- \n Propulsé par Simply Explained",
        "read_aloud_label": "♿ Lecture audio",
        "tab1_name": "💡 Simply Explained",
        "tab2_name": "📄 Documents",
        "tab3_name": "🚪 Clause d'Évasion",
        "escape_title": "La Clause d'Évasion",
        "escape_subtitle": "Stratégies d'évasion.",
        "escape_badge": "🚪 **Laboratoire d'évasion actif**",
        "escape_doc_section": "📄 Entrée de document",
        "escape_text_label": "Collez votre texte",
        "escape_text_placeholder": "Coller...",
        "escape_hint_label": "Focus tactique :",
        "escape_hint_placeholder": "ex., Éviter les frais...",
        "escape_lab_section": "🚪 Suite opérationnelle",
        "escape_urgency_label": "⚡ Urgence :",
        "escape_persona_label": "Persona :",
        "tactical_persona_prompt": "Sélectionnez votre cadre de personnage tactique ci-dessous",
        "end_suffering_btn_title": "🔴 METTRE FIN À MES SOUFFRANCES 💀",
        "end_suffering_btn_desc": "(Annihilation psychologique totale)",
        "escape_run_btn": "🚀 Exécuter",
        "escape_clear_btn": "🧹 Effacer",
        "escape_success": "Prêt !",
        "escape_no_text": "Veuillez entrer du texte.",
        "escape_spinner": "Analyse en cours...",
        "escape_disclaimer": "*À des fins de simulation uniquement.*",
        "personas": {
            "Houdini Mode": ("🪄 Mode Houdini", "Magie d'évasion"),
            "Grandma Filter": ("👵 Grand-mère", "Conseil réconfortant"),
            "Escape Hatch Locator": ("🎯 Radar de sortie", "Radar direct"),
            "7-Year-Old Playground Mindset": ("🖍️ Enfant", "Logique simple"),
            "Ruthless Barrister": ("⚖️ Avocat", "Levier juridique"),
            "Zen Negotiator": ("🧘 Zen", "Sérénité"),
            "Corporate Shark": ("🦈 Requin", "Offensif"),
            "Bureaucracy Hacker": ("🕵️ Hacker", " Contourner les robots"),
        },
    },
    "日本語": {
        "lang_label": "🌐 **言語**",
        ...
        "depth_label": "回答のスタイル: ",
        "depth_options": ["簡単", "バランス", "難解"],
        "tone_label": "🎭 **トーン / ペルソナ**",
        "tone_options": ["フレンドリー", "プロフェッショナル", "カジュアル"],
        "topic_label": "何を知りたいですか？",
        "topic_placeholder": "例：歴史、化学、政府",
        "button_label": "簡単に解説する",
        "start_over": "🧹 最初から",
        "terms_button": "📜 利用規約",
        "privacy_notice_box": '<div style="font-size: 0.8rem; padding: 10px; border-radius: 6px; background-color: rgba(2, 132, 199, 0.08); border-left: 4px solid #0284C7; margin-bottom: 15px;">🔒 <strong>プライバシー:</strong> データを保存することはありません。</div>',
        "no_api": "Gemini APIキーを入力してください。",
        "no_topic": "トピックを入力してください。",
        "ready": {"Easy": "簡単モード準備完了:", "Balanced": "バランスモード準備完了:", "Hard": "難解モード準備完了:"},
        "subtitle": "**複雑な疑問をシンプルに解決。**",
        "bottom_line": "結論",
        "spinners": {"Easy": "簡単にしています...", "Balanced": "調整中...", "Hard": "難解にしています..."},
        "pillar_headers": ["## コアコンセプト", "## それは何？", "## 仕組み", "## 何を失うか", "## なぜ重要か", "## 影響", "## 隠された事実", "## ソース"],
        "fine_print_title": "シンプリー・エクスプレインド: 規約と条件",
        "fine_print_subtitle": "法律文書の理解",
        "choose_input_mode": "入力方法の選択:",
        "input_modes": ["テキストを貼り付け", "URL"],
        "paste_label": "テキストを貼り付け",
        "url_label": "URL:",
        "upload_label": "画像アップロード:",
        "upload_pdf_label": "PDFアップロード:",
        "decode_button": "解説する",
        "simplifying_spinner": "処理中...",
        "fine_print_headers": ["## 🚦 リスク", "## 📄 条項"],
        "footer_text": "--- \n Powered by Simply Explained",
        "read_aloud_label": "♿ 音声読み上げ",
        "tab1_name": "💡 シンプリー・エクスプレインド",
        "tab2_name": "📄 ドキュメント",
        "tab3_name": "🚪 エスケープ条項",
        "escape_title": "エスケープ条項ラボ",
        "escape_subtitle": "脱出戦略の立案",
        "escape_badge": "🚪 **エスケープラボがアクティブです**",
        "escape_doc_section": "📄 シナリオ入力",
        "escape_text_label": "ここにテキストを貼り付け",
        "escape_text_placeholder": "ここに貼り付け...",
        "escape_hint_label": "追加のフォーカス:",
        "escape_hint_placeholder": "例：即座に優先度を上げる...",
        "escape_lab_section": "🚪 危機管理スイート",
        "escape_urgency_label": "⚡ 緊急度スケール:",
        "escape_persona_label": "ペルソナ:",
        "tactical_persona_prompt": "戦術的ペルソナフレームワークを以下から選択してください",
        "end_suffering_btn_title": "🔴 苦しみを終わらせる 💀",
        "end_suffering_btn_desc": "(完全な心理的抹殺)",
        "escape_run_btn": "🚀 実行",
        "escape_clear_btn": "🧹 クリア",
        "escape_success": "準備完了！",
        "escape_no_text": "テキストを入力してください。",
        "escape_spinner": "分析実行中...",
        "escape_disclaimer": "*シミュレーション目的のみ。*",
        "personas": {
            "Houdini Mode": ("🪄 フーディーニモード", "脱出のトリック"),
            "Grandma Filter": ("👵 おばあちゃんフィルター", "温かいアドバイス"),
            "Escape Hatch Locator": ("🎯 脱出ハッチ", "出口のレーダー"),
            "7-Year-Old Playground Mindset": ("🖍️ 7歳児マインドセット", "単純なロジック"),
            "Ruthless Barrister": ("⚖️ 敏腕弁護士", "厳しい法的レバレッジ"),
            "Zen Negotiator": ("🧘 禅の交渉人", "静寂と調和"),
            "Corporate Shark": ("🦈 コーポレート・シャーク", "攻撃的アプローチ"),
            "Bureaucracy Hacker": ("🕵️ 官僚ハッカー", "ロボットを迂回する"),
        },
    }
}
